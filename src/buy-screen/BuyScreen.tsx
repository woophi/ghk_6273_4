      ...
      <div className={bsSt.container}>
        ...
        >
          <Typography.Text view="secondary-medium" tag="p" defaultMargins={false}>
            Собери <b>35</b> из <b>45</b> активов от 2000 ₽ и получи шанс на главный приз в <b>1 000 000 ₽</b>
          </Typography.Text>
        ...
        <div className={bsSt.container} style={{ padding: '1rem' }}>
          ...
          <div className={bsSt.greyBox}>
            ...
            <div>
              ...
              <Typography.Text view="primary-small" tag="p" defaultMargins={false}>
                Каждый день совершайте сделки с акциями любых компаний на сумму от 2000 ₽ и получайте шансы на победу в
